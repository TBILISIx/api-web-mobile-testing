...
@Endpoint(url = "${base_url}/objects/${id}", methodType = HttpMethodType.PUT)
@SuccessfulHttpStatus(status = HttpResponseStatusType.OK_200)

public class PutObjectData extends AbstractApiMethodV2 {

    public PutObjectData(String resourceFile, String contentTypeHeader) throws IOException {
